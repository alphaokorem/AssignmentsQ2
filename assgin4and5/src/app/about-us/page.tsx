    ...
    <div>
      ...
      <div className="moveable">
        <div id="div1">
          ...
          <p>
            At Blogermen, our mission is simple: to provide readers with
            thought-provoking, high-quality content that informs, inspires, and
            empowers. We aim to spark curiosity and fuel creativity through
            well-researched, engaging blogs on diverse topics. Our vision is to
            create a space where ideas thrive, and readers find value in every
            post, contributing to a more knowledgeable, connected world.
          </p>
        </div>
        <div id="div2">
          <h1 className="center">Our Story</h1> <br />
          <p>
            Founded by a group of passionate writers and digital enthusiasts,
            Blogermen began with the idea that storytelling has the power to
            change perspectives. We started this journey to bring together
            voices from different industries, creating a platform where expert
            insights meet real-life experiences. From humble beginnings as a
            small blog, Blogermen has grown into a vibrant community where
            knowledge is shared, and inspiration is born.
          </p>
        </div>
        <div id="div3">
        ...
        <div id="div4">
          ...
          <p>
            At the heart of Blogermen is a commitment to authenticity,

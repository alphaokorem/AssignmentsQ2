  ...
  return (
    <div>
      ...
      <div className="blog">
        ...
        <p>
          We were a small group—five of us in total, meeting every Friday night
          to play the latest horror games. That evening, it was something new,
          something none of us had ever heard of. The game had no real title,
          just a strange file that had circulated around obscure forums. We
        ...
        <p>
          I could hear them—faint at first, like an echo inside my head—but they
        ...
        <p>
          I turned around, scanning the room. Nothing. Just the soft glow of my
        ...
        <p>
          I froze, my breath caught in my throat, feeling the cold crawl up my
          spine.
        </p>
        ...
        <p>
          Panicking, I reached for the power button on the monitor, my fingers
        ...
        <p>
          ...
          see it—my reflection—clear as day, staring from the black surface of
          the monitor. The whispers grew louder, circling me, as if they were
          coming from the very walls of the room. I turned around, my heart
        ...
        <p>
          I backed away from the desk, trying to get as far away as possible,
          but the thing in the screen... it followed me. I could hear it,
          moving, crawling through the monitor, through the darkness itself. The
          shadows in my room thickened, swallowing the light, until there was
          nothing but its cold presence, filling every corner, every breath.
        </p>

        <p>I ran.</p>

        <p>
          Down the hall, past every door in my house that now seemed so
          unfamiliar, so wrong. But the further I ran, the more it felt like
          something was following, like the walls themselves were closing in. I
          could feel it behind me—the reflection, or whatever it had become, was
          no longer confined to the screen. It was in the room with me now,
          chasing me through the darkness.
        </p>

        <p>
          I stumbled into the living room, my hands fumbling for the light
          switch. When I finally found it, I flicked it on. The room lit up in a
          harsh, blinding glow. But the light brought no comfort. In the
          reflection of every window, every dark surface, it was there.

    ...
    <>
      <header className="flex border-b py-3 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50">
        <div className="flex   justify-between items-center w-full">
          <p className="text-gray-800 text-2xl font-semibold">Bandage</p>
          ...
          >
            ...
            <ul className="lg:flex lg:ml-16 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
              ...
              <li className="max-lg:border-b max-lg:py-3 px-3">
                <button className="flex  text-gray-800 hover:border-b-2 hover:border-stone-800 font-semibold text-[15px]">
          ...
          <div className="hidden lg:flex space-x-5 xl:ml-80  lg:ml-8 text-blue-500 lg:justify-center lg:items-center">
            <div className="">
              <Link
                href={"javascript:void(0)"}
            ...
            <button className="flex gap-1 bg-blue-500 text-white p-3 text-sm justify-center items-center rounded">
              <p>Become a member </p>
              <img src="/rightwhite.png" alt="" className="h-5" />
            </button>
          </div>
        </div>
      </header>
